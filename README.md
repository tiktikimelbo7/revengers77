...
## Heroku
- Click [![Deploy](https://www.herokucdn.com/deploy/button.svg)](https://heroku.com/deploy?template=https://github.com/tiktikimelbo7/revengers77) and fill the environment variables accordingly. 
